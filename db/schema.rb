...
ActiveRecord::Schema[7.1].define(version: 2024_01_02_191032) do
  ...
  create_table "proponents", force: :cascade do |t|
    ...
    t.string "cpf"
    t.date "birth_date"
    t.decimal "salary", precision: 14, scale: 2
    t.bigint "user_id"
    t.text "phones"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.decimal "inss_discount", precision: 14, scale: 2, default: "0.0"
